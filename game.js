...
// =========================================================
// X. የJS ቁመት ማስገደጃ (ለሙሉ ስክሪን ችግር መፍትሄ)
// =========================================================

/**
 * 🔑 የViewportን ትክክለኛ ቁመት (vh) ያሰላል
 * ይህ በሞባይል አሳሾች ላይ የ100vh ችግርን ይፈታል (ከታችኛው አሞሌ ነፃ የሆነ vh ይሰጣል)።
 */
function setViewportHeight() {
    let vh = window.innerHeight * 0.01;
    // የ --vh ተለዋዋጭን በHTML root element ላይ ያዘጋጃል
    document.documentElement.style.setProperty('--vh', `${vh}px`);
    
    // ለሙሉ ስክሪን ጥቅም ላይ እንዲውል የCSS --app-height ተለዋዋጭን ያስተካክላል
...
document.addEventListener('DOMContentLoaded', () => {
    // 1. የቁመት ማስገደጃውን ያዘጋጃል
    setViewportHeight();
    // 2. ስክሪኑ ሲቀየር ቁመቱን ዳግም ያስተካክላል
